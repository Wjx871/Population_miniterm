<template>
  <div ref="root" class="robot-mascot" :class="{ compact }" :style="motionStyle" @pointermove="followPointer" @pointerleave="resetPointer">
