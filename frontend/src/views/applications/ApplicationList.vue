<template>
  <div class="page-container">
    ...
    <SearchPanel @search="fetchList" @reset="reset"><el-form :inline="true"><el-form-item label="申请编号"><el-input v-model.trim="query.applicationNo" clearable /></el-form-item><el-form-item label="业务类型"><el-select v-model="query.businessType" clearable><el-option v-for="(label,value) in BUSINESS_TYPE_LABEL" :key="value" :label="label" :value="value" /></el-select></el-form-item><el-form-item label="状态"><el-select v-model="query.status" clearable><el-option v-for="(label,value) in APPLICATION_STATUS" :key="value" :label="label" :value="value" /></el-select></el-form-item></el-form></SearchPanel>
