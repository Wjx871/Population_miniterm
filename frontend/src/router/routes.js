  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '数据大屏', minLevel: 1, permission: PERMISSIONS.STATISTICS_VIEW, menu: false, group: '查询统计', order: 36, icon: 'DataAnalysis', immersive: true }
      },
      {
        path: '/exports',
        name: 'ExportRecords',
